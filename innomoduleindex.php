...
/**
 *	\file       innomodule/innomoduleindex.php
 *	\ingroup    innomodule
 *	\brief      Home page of innomodule top menu
 */
...
$langs->loadLangs(array("innomodule@innomodule"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->innomodule->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("InnoModuleArea"));

print load_fiche_titre($langs->trans("InnoModuleArea"), '', 'innomodule.png@innomodule');
...
// Draft MyObject
if (! empty($conf->innomodule->enabled) && $user->rights->innomodule->read)
{
	$langs->load("orders");
