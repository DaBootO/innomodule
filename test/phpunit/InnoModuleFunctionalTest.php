...
/**
 * \file    test/phpunit/InnoModuleFunctionalTest.php
 * \ingroup innomodule
...
/**
 * Class InnoModuleFunctionalTest
 *
 ...
 *
 * @package Testinnomodule
 */
class InnoModuleFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modInnoModule')->click();
		} else {
			// Disable the module
			$this->byHref('modInnoModule')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/innomodule/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('innomodule/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/innomodule/admin/about.php');
		$this->authenticate();
		return $this->assertContains('innomodule/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('innomodulewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modInnoModule_InnoModuleTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modInnoModule_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
